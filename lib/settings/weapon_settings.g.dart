...
_$WeaponSettingsImpl _$$WeaponSettingsImplFromJson(Map<String, dynamic> json) =>
    _$WeaponSettingsImpl(
      ...
      explosionSizeX: (json['explosionSizeX'] as num).toDouble(),
      explosionSizeY: (json['explosionSizeY'] as num).toDouble(),
...
Map<String, dynamic> _$$WeaponSettingsImplToJson(
    ...
    <String, dynamic>{
      ...
      'explosionSizeX': instance.explosionSizeX,
      'explosionSizeY': instance.explosionSizeY,
