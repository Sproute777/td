...
//-------------------------------------------
  ...
  final selectedWeaponSubject = BehaviorSubject<WeaponComponent?>.seeded(null);
  final weaponTypeNotifier = ValueNotifier(WeaponType.none);
  ...
  void setSelectedWeapon(WeaponComponent? component) {
    selectedWeaponSubject.value = component;
  }
  // void setCost({
  //   required int cost,
  //   required int index,
